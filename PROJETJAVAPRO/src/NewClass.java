...
public class NewClass {
    ...
    public ArrayList selectAll(ArrayList<Informaticien> myArray, Informaticien info) {
        ArrayList<Informaticien> tab = new ArrayList<>();
        for (Informaticien o : myArray) {
            if (o.getMoyenne() == info.getMoyenne()) {
                tab.add(o);
            } else {
                continue;
            }
    ...
    public void afficherMoyenneMax() {
        ArrayList<Informaticien> tab = new ArrayList<>();
        tab = selectAll(tabAll(), moyenneMax());
        if (tab.size() == 0) {
            System.out.println("\n\n\t\tAucun candidat enregistrer\n\n");
        } else {
            for (Informaticien e : tab) {
